<?php echo view('layout/header');?>
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <form name="tambahdata" method="POST" action="<?php echo base_url('sekolah/saveeditsekolah/'.$row->id_sekolah.'')?>">
      <div class="container-fluid">
        <div class="row">
          <!-- left column -->
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_sekolah" class="form-control" value="<?php echo $row->nama_sekolah?>">
                  </div>
                  <div class="form-group">
                    <label>NPSN</label>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="operator" class="form-control" value="<?php echo $row->operator?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label>Waktu</label>
                    <input type="text" name="waktu" class="form-control" value="<?php echo $row->waktu?>">
                  </div>
                </div>
                <!-- /.card-body -->
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="kebutuhan_khusus_dilayani" class="form-control" value="<?php echo $row->kebutuhan_khusus_dilayani?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="cabang_kcp_unit" class="form-control" value="<?php echo $row->cabang_kcp_unit?>">
                  </div>
                  <div class="form-group">
            ...
            <div class="card card-info">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="jml_ptk" class="form-control" value="<?php echo $row->jml_ptk?>">
                </div>
                <div class="form-group">
            ...
            <div class="card card-success">
              ...
              <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2 select2-danger" data-dropdown-css-class="select2-danger" name="id_bentuk_pendidikan" style="width: 100%;">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2 select2-danger" data-dropdown-css-class="select2-danger" name="yayasan" style="width: 100%;">
                      <option value="<?php echo $row->id_yayasan?>"><?php echo $row->nm_yayasan?><option>
                        <?php
            ...
            <div class="card card-danger">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="waku_penyelenggaraan" class="form-control" value="<?php echo $row->waku_penyelenggaraan?>">
                </div>
                <div class="form-group">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label>RT / RW</label>
                <input type="text" name="rt_rw" class="form-control" value="<?php echo $row->rt_rw?>">
              </div>
              <div class="form-group">
                <label>Dusun</label>
                <input type="text" name="dusun" class="form-control" value="<?php echo $row->dusun?>">
              </div>
              <div class="form-group">
                <label>Desa / Kelurahan</label>
                <input type="text" name="desa_kelurahan" class="form-control" value="<?php echo $row->desa_kelurahan?>">
              </div>
              <div class="form-group">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" name="kabupaten" class="form-control"  value="<?php echo $row->kabupaten?>" disabled>
              </div>
              <div class="form-group">
                <label>Provinsi</label>
                <input type="text" name="provinsi" class="form-control"  value="<?php echo $row->provinsi?>" disabled>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label>Lintang</label>
                <input type="text" name="lintang" class="form-control" value="<?php echo $row->lintang?>">
              </div>
              <div class="form-group">
                <label>Bujur</label>
                <input type="text" name="bujur" class="form-control" value="<?php echo $row->bujur?>">
              </div>
            </div>
          </div>
        </div>
