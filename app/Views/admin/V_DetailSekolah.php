          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center"><?php echo $row->nama_sekolah;?></h3>

                <p class="text-muted text-center"><?php echo $row->npsn;?></p>

                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    Kepsek : <b class="float-center"><?php echo $row->nama_kepsek;?></b>
                  </li>
                  <li class="list-group-item">
                    Operator : <b class="float-center"><?php echo $row->operator;?></b>
                  </li>
                  <li class="list-group-item">
                  ...
                  <li class="list-group-item">
                    Waktu : <b class="float-center"><?php echo $row->waktu;?></b>
                  </li>
                </ul>
              </div>
              <!-- /.card-body -->
                        ...
                        <div class="card card-primary">
                          ...
                          <!-- /.card-body -->
                            ...
                            <ul class="list-group list-group-flush">
                              ...
                              <li class="list-group-item"><b>Status Kepemilikan :</b> <?php echo $row->status_kepemilikan; ?></li>
                    ...
                    <div class="col-md-6">
                        <div class="card card-primary">
                          ...
                          <!-- /.card-body -->
                            ...
                            <ul class="list-group list-group-flush">
                              <li class="list-group-item"><b>Alamat :</b> <?php echo $row->alamat;?></li>
                              ...
                              <li class="list-group-item"><b>Kabupaten :</b> <?php echo $row->kabupaten;?></li>
                              <li class="list-group-item"><b>Provinsi :</b> <?php echo $row->provinsi;?></li>
                              <li class="list-group-item"><b>Kode Pos :</b> <?php echo $row->kode_pos;?></li>
                              <li class="list-group-item"><b>Lintang :</b> <?php echo $row->lintang;?></li>
                              <li class="list-group-item"><b>Bujur :</b> <?php echo $row->bujur;?></li>
                            </ul>                         
                          <!-- /.card-body -->
                        </div>
                        <!-- /.card -->
